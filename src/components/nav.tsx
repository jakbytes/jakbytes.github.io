...
export default function NavBar({ page }: { page: string }) {
    return (
        <Navbar fluid rounded className=" bg-primary backdrop-blur-lg font-main">
            ...
            <NavbarToggle />
            <NavbarCollapse>
                <NavbarLink href="/" active={page == "home"} className="text-text_primary">
                    Home
                </NavbarLink>
                <NavbarLink href="/our-apps" active={page == "our-apps"} className="text-text_primary">
                    Apps
                </NavbarLink>
                <NavbarLink as={Link} href="/about" active={page == "about"} className="text-text_primary">
                    About
                </NavbarLink>
                <NavbarLink href="/contact-us" active={page == "contact-us"} className="text-text_primary">Contact</NavbarLink>
            </NavbarCollapse>
        </Navbar>
    );
}