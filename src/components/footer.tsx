export default function Footer() {
    return (
        <footer
            ...
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://jakbytes.com/" className="hover:underline">jakbytes™</a>. All Rights Reserved.</span>
